...
class Pelicula {
    ...
    /*listadoPorRanking() {
        return `Titulo: ${this.titulo} - Ranking: (${this.ranking}*)`
    }*/
}
...
//- Clasificar por Ranking -//  // Muestra Catalogo por Ranking
/*function mostrarPorRanking() {
    let porRanking = "Catalogo por Ranking: \n"


    catalogoPeliculas.forEach(pelicula => {
        porRanking = porRanking + pelicula.titulo + " - Ranking: " + pelicula.ranking + "\n"
    });
    return porRanking

}

//- Clasificar por Genero - //  //Muestra Catalogo por Genero
function mostrarPorGenero() {
    let porGenero = "Catalogo por Genero: \n"
